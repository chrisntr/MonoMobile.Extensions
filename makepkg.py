...
xpkg_args = [
	...
	"--icon", "component/xamarin.mobile_128x128.png",
	"--icon", "component/xamarin.mobile_512x512.png",
	"--library", "ios:" + IOSDLL,
	...
	"--sample-no-manifest", "Xamarin.Mobile Windows Phone 7.5 Samples. Windows Phone 7 samples for the AddressBook, MediaPicker and Geolocator APIs.:WindowsPhone/Samples/Xamarin.Mobile.WP.Samples.sln",
	"--sample-no-manifest", "Xamarin.Mobile Windows Phone 8 Samples. Windows Phone 8 Samples for the AddressBook, MediaPicker and Geolocator APIs.:WindowsPhone8/Samples/Xamarin.Mobile.WP8.Samples.sln",
	"--sample-no-manifest", "Xamarin.Mobile Windows 8 Samples. Windows 8 Samples for the MediaPicker and Geolocator APIs.:WindowsRT/Samples/Xamarin.Mobile.WinRT.Samples.sln"
]
